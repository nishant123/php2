...
(4, 'nishant', 'chawla.nishant@gmail.com', 9742478219, 'nishant@123');
...
(3, 3, 23, 6, 'chawla.nishant@gmail.com', '300', 'In Process');
...
--
ALTER TABLE `tblcart`
  MODIFY `fld_cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
