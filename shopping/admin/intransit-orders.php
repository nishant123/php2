                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
<?php $query=mysqli_query($con,"SELECT ".PREFIX."orders.id,orderNumber,totalAmount,orderStatus,orderDate,".PREFIX."users.name,".PREFIX."users.contactno 
    FROM `".PREFIX."orders` join ".PREFIX."users on ".PREFIX."users.id=".PREFIX."orders.userId where (orderStatus='In Transit')");
$cnt=1;
