...
<?php $query=mysqli_query($con,"SELECT ".PREFIX."orders.id,orderNumber,totalAmount,orderStatus,orderDate,".PREFIX."users.name,".PREFIX."users.contactno 
    FROM `".PREFIX."orders` join ".PREFIX."users on ".PREFIX."users.id=".PREFIX."orders.userId where (".PREFIX."users.name like '%$searchinput%' || ".PREFIX."orders.orderNumber like '%$searchinput%')");
$cnt=1;
