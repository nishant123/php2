...
$ret=mysqli_query($con,"SELECT id FROM ".PREFIX."tbladmin WHERE username='$username' and contactNumber='$cnumber'");
$num=mysqli_num_rows($ret);
if($num>0)
{
$query=mysqli_query($con,"update ".PREFIX."tbladmin set password='$newpassword' WHERE username='$username' and contactNumber='$cnumber'");
