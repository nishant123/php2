...
<?php 
$pid=intval($_GET['id']);
$query=mysqli_query($con,"select ".PREFIX."products.id as pid,".PREFIX."products.productImage1,".PREFIX."products.productImage2,".PREFIX."products.productImage3,".PREFIX."products.productName,".PREFIX."category.categoryName,".PREFIX."subcategory.subcategoryName as subcatname,".PREFIX."products.postingDate,".PREFIX."products.updationDate,".PREFIX."subcategory.id as subid,".PREFIX."tbladmin.username,".PREFIX."category.id as catid,".PREFIX."products.productCompany,".PREFIX."products.productPrice,".PREFIX."products.productPriceBeforeDiscount,".PREFIX."products.productAvailability,".PREFIX."products.productDescription,".PREFIX."products.shippingCharge from ".PREFIX."products join ".PREFIX."subcategory on ".PREFIX."products.subCategory=".PREFIX."subCategory.id join ".PREFIX."category on ".PREFIX."products.category=".PREFIX."category.id join ".PREFIX."tbladmin on ".PREFIX."tbladmin.id=".PREFIX."products.addedBy where  ".PREFIX."products.id='$pid' order by pid desc");
