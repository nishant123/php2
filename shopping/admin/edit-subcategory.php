...
if(isset($_POST['submit']))
{
    ...
    $id=intval($_GET['id']);
$sql=mysqli_query($con,"update ".PREFIX."subcategory set categoryid='$category',subcategoryName='$subcat' where id='$id'");
...
<?php
$id=intval($_GET['id']);
$query=mysqli_query($con,"select ".PREFIX."category.id,".PREFIX."category.categoryName,".PREFIX."subcategory.subcategoryName from ".PREFIX."subcategory join ".PREFIX."category on ".PREFIX."category.id=".PREFIX."subcategory.categoryid where ".PREFIX."subcategory.id='$id'");
