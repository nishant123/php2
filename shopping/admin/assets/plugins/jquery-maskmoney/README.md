 ...
 * ```allowZero```: use this setting to prevent shop_users from inputing zero. default: false
 * ```allowNegative```: use this setting to prevent shop_users from inputing negative values. default: false
