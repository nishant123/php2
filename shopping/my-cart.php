...
// echo "insert into ".PREFIX."orders(userId,productId,quantity) values('".$_SESSION['id']."','$qty','$val34')";die;

mysqli_query($con,"insert into ".PREFIX."orders(userId,productId,quantity,totalAmount) values('".$_SESSION['id']."','$qty','$val34','$totalamt')");
...
if(!empty($_SESSION['cart'])){
 ...
 <?php
 $pdtid=array();
    $sql = "SELECT * FROM ".PREFIX."products WHERE id IN(";
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo $row['productImage1'];?>" alt="" width="114" height="146">
						</a>
					</td>
...
$_SESSION['sid']=$pd;
						...
						<div class="row">
							...
							<div class="col-sm-8">
<?php $rt=mysqli_query($con,"select * from ".PREFIX."productreviews where productId='$pd'");
...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rs"." ".$row['shippingCharge']; ?>.00</span></td>
					...
					<td class="cart-product-grand-total"><span class="cart-grand-total-price"> <input type="hidden" value="<?php echo $_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']; ?>" name="totalamt"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.00</span></td>
				</tr>
		...
		<tbody>
				<tr>
					<td>
						...
						<?php $qry=mysqli_query($con,"select * from ".PREFIX."users where id='".$_SESSION['id']."'");
