...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		$sql_p="SELECT * FROM ".PREFIX."products WHERE id={$id}";
...
{
mysqli_query($con,"insert into ".PREFIX."wishlist(userId,productId) values('".$_SESSION['id']."','$pid')");
...
if(isset($_POST['submit']))
{
	...
	$review=$_POST['review'];
	mysqli_query($con,"insert into ".PREFIX."productreviews(productId,quality,price,value,name,summary,review) values('$pid','$qty','$price','$value','$name','$summary','$review')");
}
...
<?php
$ret=mysqli_query($con,"select ".PREFIX."category.categoryName as catname,".PREFIX."subCategory.subcategory as subcatname,".PREFIX."products.productName as pname from ".PREFIX."products join ".PREFIX."category on ".PREFIX."category.id=".PREFIX."products.category join ".PREFIX."subcategory on ".PREFIX."subcategory.id=".PREFIX."products.subCategory where ".PREFIX."products.id='$pid'");
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	...
	<div class="sidebar-widget-body m-t-10">
		<div class="accordion">
		            ...
		            <?php $sql=mysqli_query($con,"select id,categoryName  from ".PREFIX."category");
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
								   ...
								   <?php
$ret=mysqli_query($con,"select * from ".PREFIX."products order by rand() limit 4 ");
...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($rws['productName']);?>/<?php echo htmlentities($rws['productImage1']);?>"  width="200" height="334" alt="">
							</div>
...
<?php 
$ret=mysqli_query($con,"select * from ".PREFIX."products where id='$pid'");
...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']);?>" href="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" width="370" height="350" />
                </a>
            </div>
            ...
            <div class="single-product-gallery-item" id="slide2">
                <a data-lightbox="image-1" data-title="Gallery" href="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage2']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage2']);?>" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide3">
                <a data-lightbox="image-1" data-title="Gallery" href="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage3']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage3']);?>" />
                </a>
            </div>
            ...
            <div id="owl-single-product-thumbnails">
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide1">
                        <img class="img-responsive"  alt="" src="assets/images/blank.gif" data-echo="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" />
                    </a>
                </div>

            <div class="item">
                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide2">
                        <img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" data-echo="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage2']);?>"/>
                    </a>
                </div>
                <div class="item">

                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="3" href="#slide3">
                        <img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" data-echo="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage3']);?>" height="200" />
                    </a>
                </div>
...
<?php $rt=mysqli_query($con,"select * from ".PREFIX."productreviews where productId='$pid'");
...
<?php $qry=mysqli_query($con,"select * from ".PREFIX."productreviews where productId='$pid'");
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
		...
		<?php 
$qry=mysqli_query($con,"select * from ".PREFIX."products where subCategory='$subcid' and category='$cid'");
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($rw['id']);?>/<?php echo htmlentities($rw['productImage1']);?>" width="150" height="240" alt=""></a>
			</div><!-- /.image -->			
