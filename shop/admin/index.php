...
if(isset($_POST['submit']))
{
	...
	//echo "SELECT * FROM ".PREFIX."admin WHERE username='$username' and password='$password'";die;
$ret=mysqli_query($con,"SELECT * FROM ".PREFIX."admin WHERE username='$username' and password='$password'");
