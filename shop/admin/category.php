...
$sql=mysqli_query($con,"insert into ".PREFIX."category(categoryName,categoryDescription) values('$category','$description')");
...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from ".PREFIX."category where id = '".$_GET['id']."'");
