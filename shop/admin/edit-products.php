...
$sql=mysqli_query($con,"update  ".PREFIX."products set category='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
$query=mysqli_query($con,"select ".PREFIX."products.*,".PREFIX."category.categoryName as catname,".PREFIX."category.id as cid,".PREFIX."subcategory.subcategory as subcatname,".PREFIX."subcategory.id as subcatid from ".PREFIX."products join ".PREFIX."category on ".PREFIX."category.id=".PREFIX."products.category join ".PREFIX."subcategory on ".PREFIX."subcategory.id=".PREFIX."products.subCategory where ".PREFIX."products.id='$pid'");
$cnt=1;
...
<?php $query=mysqli_query($con,"select * from ".PREFIX."category");
...
<div class="controls">
<img src="<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> <a href="update-image1.php?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
...
<div class="controls">
<img src="<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> <a href="update-image2.php?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
...
<div class="controls">
<img src="<?php echo PRODUCTIMAGES; ?>/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>" width="200" height="100"> <a href="update-image3.php?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
<?php } ?>
	<div class="control-group">
