...
$query=mysqli_query($con,"select max(id) as pid from ".PREFIX."products");
...
<option value="<?php echo $row['id'];?>"  <?php if ($row['categoryName']=='undefined'){echo "selected";} ?>><?php echo $row['categoryName'];?></option>
<?php } ?>
</select>
</div>
</div>
