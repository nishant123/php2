...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
$sql=mysqli_query($con,"update ".PREFIX."category set categoryName='$category',categoryDescription='$description',updationDate='$currentTime' where id='$id'");
...
<?php
$id=intval($_GET['id']);
$query=mysqli_query($con,"select * from ".PREFIX."category where id='$id'");
