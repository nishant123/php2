...
<h3>NDH Supermarket</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Very good service and good collection in stock. Almost all varities shown about daily need products. So afordable.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                  Helpline:  9050401928 (Whatsapp/Call)
                </div>
            </li>
