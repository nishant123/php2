...
header('location:index.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update ".PREFIX."users set billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode' where id='".$_SESSION['id']."'");
		if($query)
		{
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$query=mysqli_query($con,"update ".PREFIX."users set shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode' where id='".$_SESSION['id']."'");
		if($query)
		{
...
<!-- checkout-step-01  -->
				...
				<?php
$query=mysqli_query($con,"select * from ".PREFIX."users where id='".$_SESSION['id']."'");
while($row=mysqli_fetch_array($query))
{
?>
