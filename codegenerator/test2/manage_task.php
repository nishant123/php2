...
<div class="container-fluid">
	<form action="" id="manage-task">
		...
		<div class="form-group">
			...
			<input type="text" class="nishant nishant-sm" name="task" value="<?php echo isset($task) ? $task : '' ?>" required>
		</div>
		<div class="form-group">
			<label for="">Description</label>
			<textarea name="description" id="" cols="30" rows="10" class="summernote nishant">
