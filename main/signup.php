...
<body>
  ...
  <input type="text" class= "input-sinup"name="fullname" id="fullname"><br/>
  <label for="email"class="label-singup">Email Address</label><br/>
  <input type="text" class= "input-sinup"  name="email" id="email"><br/>
  <label for="mobilenumber"class="label-singup">Mobile Number</label><br/>
  <input type="text" class= "input-sinup" name="phno" id="phno"><br/><br/>
